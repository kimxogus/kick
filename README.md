...
- 별도 백엔드와 원격 DB는 두지 않고, Next.js route handler와 seed fixture/memory store로 MVP API를 구현합니다.
...
- 제작자: MCP/Skill을 통해 제품 분석, 타겟 분석, 셀링 포인트, 피드백, 런칭페이지/카드뉴스/홍보 카피 초안을 만들고 kick 등록 payload까지 이어갑니다.
