...
이 문서는 repo 개발자와 agent가 로컬 실행, 테스트, 문서, plugin 패키징 작업을 할 때 참고하는 개발 가이드입니다. 사용자용 plugin 설치와 제품 등록 안내는 [README.md](README.md)를 봅니다.
...
사용자용 plugin 설치와 제품 등록 안내는 [README.md](README.md)를 유지합니다.
...
- [README.md](README.md): 사용자용 plugin 설치와 제품 등록 빠른 시작
